...
public  class DbUtils {
    ...
    private static Connection getDBConnection(Config config) {
        ...
        String dbDriver = config.getString("oraclejdbc.driver");
        String dbUrl = config.getString("oraclejdbc.url");
        String dbUser = config.getString("oraclejdbc.user");
        String dbPass = config.getString("oraclejdbc.password");
